...
public class Main_Activity extends Activity implements OnItemClickListener {
	...
	Handler mHandler = new Handler(){
		...
		public void handleMessage(Message msg) {
			...
			case MESSAGE_READ:
                ...
                Log.i(tag, "Serial: " + string);
                logTextView.setText("Serial Read: " + string);

                if(string.equals("1")) {
                    Log.i(tag, "Garage Open");
                    try {
                        String url = "http://homeIpAddress/?trigger=1";
	...
	private void init() {
        ...
        logTextView=(TextView)findViewById(R.id.tvSerial);
